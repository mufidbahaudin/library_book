...
$result = $conn->query("SELECT id_manager, nama_manager, jabatan FROM manager");
...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="alert alert-success" role="alert">
      Hello, <?= htmlspecialchars($_SESSION['username']) ?>!. Anda adalah <strong>ADMIN</strong>, anda bisa melakukan edit, dan hapus manager
    </div>

    <!-- Notifikasi -->
    <?php if (isset($_GET['message'])): ?>
      <?php if ($_GET['message'] == 'success'): ?>
        <div class="alert alert-success">Manager berhasil dihapus!</div>
      <?php elseif ($_GET['message'] == 'error'): ?>
        <div class="alert alert-danger">Terjadi kesalahan saat menghapus manager!</div>
      <?php elseif ($_GET['message'] == 'invalid'): ?>
        <div class="alert alert-warning">ID manager tidak valid!</div>
      <?php endif; ?>
    <?php endif; ?>
        ...
        <?php if ($result->num_rows > 0): ?>
          <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
              ...
              <td>
                <a href="edit_manager.php?id_manager=<?= htmlspecialchars($row['id_manager']) ?>" class="btn btn-warning btn-sm">Edit</a>
                <a href="hapus_manager.php?id_manager=<?= htmlspecialchars($row['id_manager']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus manager ini?')">Hapus</a>
              </td>
            </tr>
          <?php endwhile; ?>
        <?php else: ?>
          <tr>
            <td colspan="3" class="text-center">Tidak ada data manager.</td>
          </tr>
        <?php endif; ?>
      </tbody>
    </table>
