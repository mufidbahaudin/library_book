...
<head>
    ...
    <link rel="stylesheet" href="css/reader_dboard.css">
</head>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-3">
                    <li class="nav-item">
                        <a class="nav-link active" href="reader_dashboard.php">Dashboard</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="jumbotron text-center text-white">
        <div class="px-4 py-5 my-5">
            ...
            <a href="reader_daftar_buku.php" class="btn btn-primary mt-3">Cari Buku</a>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="img/becca-tapert-GnY_mW1Q6Xc-unsplash.jpg" class="card-img-top" alt="Akses Buku" loading="lazy">
                        <div class="card-body">
                            <h4 class="fs-5">Akses ke Koleksi Buku yang Lengkap</h4>
                            <a href="reader_benefit.php" class="btn btn-primary text-white">Read More..</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="img/eliott-reyna-kcT-7cirBEw-unsplash.jpg" class="card-img-top" alt="Akses Buku" loading="lazy">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="img/nick-fewings-f2Bi-VBs71M-unsplash.jpg" class="card-img-top" alt="Akses Buku" loading="lazy">
                        <div class="card-body">
